...
import com.test.doctorapplication.Adapter.MyNotificationAdapter;
import com.test.doctorapplication.Common.Common;
import com.test.doctorapplication.Interface.INotificationListener;
import com.test.doctorapplication.Interface.INotificationLoadListener;
...
public class NotificationActivity extends AppCompatActivity implements INotificationLoadListener {
    ...
    public void onNotificationLoadSuccess(List<MyNotification> notificationList, DocumentSnapshot lastDocument) {
        if (lastDocument != null)
        {
            ...
            {
                adapter = new MyNotificationAdapter(this, notificationList);
